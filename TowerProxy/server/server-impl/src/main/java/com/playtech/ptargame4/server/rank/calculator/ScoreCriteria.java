...
public enum ScoreCriteria {
	...
	BRIDGES_BUILT("bridgesBuilt", 0.1, 50),
    BRIDGES_DESTROYED("bridgesDestroyed", 0.1, 50),
    BRIDGE_SOLDIER_ENEMY_KILLS("enemyKills", 0.1, 20),
    BRIDGE_SOLDIER_SAVES("soldierSaves", 0.1, 20),
    BRIDGE_SOLDIER_DEATH("soldierDeaths", 0.1, 20),
    BRIDGE_SOLDIER_ENEMY_SAVES("enemySaves", 0.1, 20),;
