...
if( currentPhase == MainPhase.INIT ){
	...
	draw_text( room_width/2, room_height*0.21, "WAITING FOR PLAYERS" );
	draw_text_transformed( room_width*0.5, room_height*0.25, "Register @ tower.playtech.ee", 0.75, 0.75, 0 );
	draw_set_font( -1 );
}
